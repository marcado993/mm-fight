...
export const gyms: Gym[] = [
  ...
  {
    id: "g5",
    name: "Cobra Kai Quito",
    tagline: "Strike First, Strike Hard, No Mercy en la altura.",
    city: "Quito",
    province: "Pichincha",
    address: "La Mariscal, Quito",
    logo: "/gyms/cobra-logo.png",
    coverPhoto: "/gyms/cobra-cover.jpg",
    coaches: ["Hugo \"Víbora\" López"],
    totalWins: 55,
    totalLosses: 12,
    totalDraws: 0,
    koRate: 85,
  ...
  {
    id: "g6",
    name: "Valhalla MMA Altura",
    tagline: "Solo los dignos entran al Valhalla.",
    city: "Quito",
    province: "Pichincha",
    address: "Cumbayá, Quito",
    logo: "/gyms/valhalla-logo.png",
    coverPhoto: "/gyms/valhalla-cover.jpg",
    coaches: ["Odin Silva"],
    totalWins: 102,
    totalLosses: 40,
    totalDraws: 5,
